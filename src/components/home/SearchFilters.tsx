...
export function SearchFiltersComponent({
  ...
  const handleSearchSubmit = () => {
    const newFilters = {
      ...
      faixaIdadeInicial: localIdadeMinima
        ? parseInt(localIdadeMinima)
        : undefined,
      faixaIdadeFinal: localIdadeMaxima
        ? parseInt(localIdadeMaxima)
        : undefined,
  ...
  const handleAgeFilterChange = (field: "minima" | "maxima", value: string) => {
    if (field === "minima") {
      ...
      <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 justify-between items-start sm:items-center">
        <div className="flex flex-wrap gap-2 order-2 sm:order-1 w-full sm:w-auto">
          ...
          <Button
            ...
            disabled={loading}
            className={`transition-all duration-200 hover:bg-gray-50 dark:hover:bg-gray-800 dark:border-gray-600 ${
              loading ? "opacity-60 cursor-not-allowed" : ""
            }`}
          >
          ...
          {hasActiveFilters && (
            <Button
              ...
              disabled={loading}
              className={`transition-all duration-200 hover:bg-gray-50 text-red-600 hover:text-red-700 dark:hover:bg-gray-800 dark:text-red-400 dark:hover:text-red-300 dark:border-gray-600 ${
                loading ? "opacity-60 cursor-not-allowed" : ""
              }`}
            >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleAgeFilterChange("minima", e.target.value)
                  }
                  disabled={loading}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleAgeFilterChange("maxima", e.target.value)
                  }
                  disabled={loading}
                />
              </div>
